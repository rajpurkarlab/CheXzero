...
def parse_args():
    ...
    parser.add_argument('--chest_x_ray_path', default='data/CheXpert/test/', help="Directory where chest x-ray image data is stored. This should point to the files folder from the MIMIC chest x-ray dataset.")
